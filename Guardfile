...
#guard 'coffeescript', :input => 'src/spec/public', :output => 'public/javascripts/spec', :debug_info_ => true
guard 'coffeescript', :input => 'src/spec', :output => 'spec', :debug_info_ => true
guard 'coffeescript', :input => 'src/test', :output => 'test', :debug_info_ => true
